...
import org.toughradius.tester.common.bits.NetBits;
...
public class RadiusUtil {
	...
	public static String randomNasPortId() {
		Random random = new Random();
		return String.format("3/0/1:%s.%s", random.nextInt(0x800),random.nextInt(0x800));
	}

	public static String randIpaddr(){
		Random random = new Random();
		return String.format("10.%s.%s.%s",random.nextInt(0xfe), random.nextInt(0xfe),random.nextInt(0xfe));
	}
